...
def main():
    ...
    if website_menu == "Emotion Recognition":
        ...
        link = '[GitHub repository of the web-application]' \
               '(https://github.com/saurabhverma18/ToneSense)'
        ...
        with col1:
            ...
            st.info("ranjeetkryadav1719@gmail.com")
            st.info("yashsinghal@gmail.com")
        with col2:
            liimg = Image.open("images/LI-Logo.png")
            st.image(liimg)
            st.markdown(f""":speech_balloon: [Saurabh Verma(Group Leader)](https://www.linkedin.com/in/saurabhverma18/)""",
                        unsafe_allow_html=True)
            st.markdown(f""":speech_balloon: [Madhuresh(Team Member 1)](https://www.linkedin.com/in/madhuresh-verma-309bb4257/)""",
                        unsafe_allow_html=True)
            st.markdown(f""":speech_balloon: [Ranjeet Kumar Yadav(Team Member 2)](https://www.linkedin.com/in/ranjeet-kumar-yadav-7721492ba/)""",
                        unsafe_allow_html=True)
            st.markdown(f""":speech_balloon: [Yash Singhal(Team Member 3)](https://www.linkedin.com/in/..)""",
                        unsafe_allow_html=True)
        ...
        if st.button("Enjoy Random Quotes"):
            with st.container():
                col1, col2 = st.columns(2)
